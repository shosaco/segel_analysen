...
pirateplot(formula = speed ~ Boot,
           data = dat, inf.f.o = 0.1, point.o = .8) 
```

**Beobachtung:** Interessanterweise sind die Gewichts-Extreme auch die schnellsten: Die Gleitjolle *470er* und die Kielboote *Kielzugvogel* und *C55*, wobei der Kielzugvogel deutlich die größte Maximalgeschwindigkeit erreicht. Die *J70* ist das Bundesliga-Regatta-Boot und sollte schneller sein, aber an dem einen Tag war wohl nicht viel Wind :-)
