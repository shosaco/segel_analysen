...
Dies ist eine Fallstudie zur **explorativen Datenanalyse** auf selbst gesammelten GPS-Daten. Anhang einiger Datenmassage-Pakete (wie `XML` oder `tidyverse`) sowie  Visualisierungen (`ggplot2`, `highcharter`, `leaflet`) können wir Zusammenhänge erkunden, die jedoch nicht weitergehend durch Hypothesentests untersucht werden.
